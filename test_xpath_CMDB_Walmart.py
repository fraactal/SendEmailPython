...
def send_mail_host():
    ...
    from_address = "jonas.aws.777@gmail.com"
    smtp_password = "ctbc tjap evmn dtmh"
    #to_address = "jonathan.valdes.o@gmail.com,jonathan.valdes@darts-ti.com,alvaro.navarro@darts-ti.com,daniel.torres@darts-ti.com,jonathan.valdes@walmart.com"
